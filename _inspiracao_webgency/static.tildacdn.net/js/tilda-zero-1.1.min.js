  ...
  if (r) {
    ...
    if (o)
      try {
        ...
        return (
          console.error("Error parsing form inputs textarea value:", n, o), []
        );
      }
  }
  return [];
  ...
  switch (e) {
    case "left":
      ...
      !u && d ? "grid" === h && c && (y *= k) : (y = A + y),
        ...
        f &&
          "window" !== F &&
          (y += ((S = t396_elem__getWidth(r)) * k - S) / 2);
      break;
    case "top":
      var O = r.closest(".t396__artboard"),
      ...
      i.forEach(function (t) {
        ...
        window.t396__isSafari &&
          ...
          e &&
            ...
            t.isRelativeLineHeight ||
              (t.atom.style.lineHeight = Math.round(e) + "px"));
      });
    });
}
